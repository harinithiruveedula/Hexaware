...
/*
xml datatype colimns cannot be used as primary key and fireign key and unique

two ways of storing XML documents

->typed
->untyped
a cloumn that is asscoiated with xml values is called typed xml
untyped xml scgema does not have any defibation
to create a untyped we have to create xml documents